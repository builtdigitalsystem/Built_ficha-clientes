...
import { ChevronDown, ChevronUp, ChevronLeft, ChevronRight, Download, Printer, EyeOff } from "lucide-react";
...
function Dashboard() {
  ...
  const exportarCSV = () => {
    const headers = ["Nombre", "Correo", "Plan", "Fecha inicio", "Fecha fin", "Monto", "Estado", "Nota de seguimiento"];
      ...
      <html>
        <head>
          ...
          <style>
            ...
            .label { font-size: 11px; color: #9C9890; margin-top: 16px; }
            .valor { font-size: 15px; }
          </style>
        </head>
        <body>
          <h1>${f.nombre || ""}</h1>
          <div class="valor">${f.correo || ""}</div>
